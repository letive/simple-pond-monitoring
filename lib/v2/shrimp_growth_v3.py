...
from lib.helpers_mod import normal_trapezoidal, left_trapezoidal, heaviside_step, integrate_function
...
class ShrimpGrowth:
    ...
    def weight(t0, t, w0, wn, fr, alpha, condition):
        ...
        """
        integrale1 = quad(integrate_function, t0, t, args=(fr[0], condition[0], "temperature"))[0]
        integrale2 = quad(integrate_function, t0, t, args=(fr[1], condition[1], "nh4"))[0]
        integrale3 = quad(integrate_function, t0, t, args=(fr[2], condition[2], "do"))[0]

        # print(alpha)

        wt = (wn**(1/3) - (wn**(1/3) - w0**(1/3))* np.exp(-1 * (alpha[0]*integrale1 + alpha[1]*integrale2 + alpha[2]*integrale3)))**3
        return wt
